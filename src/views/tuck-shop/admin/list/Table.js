...
const AdminsTable = () => {
	...
	const filteredData = store.allData.filter((item) => item.phone.toLowerCase() || item.firstName.toLowerCase() || item.lastName.toLowerCase())
						...
						<Col lg="4" md="6">
							<FormGroup>
								...
								<Input
									...
									type="text"
									value={searchTerm}
									placeholder="Name and Phone Search"
