...
const statusObj = {
	UNSETTLED: 'light-warning',
	SETTLED: 'light-success',
}
...
export const columns = [
		...
		cell: (row) => (
			<div className="d-flex justify-content-left align-items-center">
				...
				<div className="d-flex flex-column">
					<Link to={`/student/view/${row.studentId}`} className="user-name text-truncate mb-0">
	...
	// },
	{
	  ...
	  sortable: true,
	  cell: row => (
	    <Badge className='text-capitalize' color={statusObj[row.settlementId ? 'SETTLED' : 'UNSETTLED']} pill>
	      {row.settlementId ? 'SETTLED' : 'UNSETTLED'}
	    </Badge>
	  )
	},
	{
